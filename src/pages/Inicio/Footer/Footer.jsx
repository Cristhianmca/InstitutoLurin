      ...
      <footer className="footer">
        <div className="footer-container">
            <div className="footer-section about">
                ...
                <p className="footer-description">Nuestro objetivo fundamental es formar profesionales en los tres programas de estudios que brindamos CONTABILIDAD, DISEÑO Y PROGRAMACIÓN WEB y PRÓTESIS DENTAL, con una sólida base científica y tecnológica, un alto nivel de especialización.</p>
            </div>
            ...
            <div className="footer-section contact">
                ...
                <p className="footer-contact">Dirección: A.H. Villa Alejandro 1ra Etapa - Mz. K, Lt. 15/16, Lurín <a target='_blank' href="https://maps.app.goo.gl/LicQTD8PFPDB2iXs5"><i className="fa-duotone fa-location-dot"  ></i></a> </p>
        ...
        ></iframe> */}
            ...
            <div className="footer-section social">
                ...
                <div className="footer-social-icons">
                    <a target='_blank' href="https://www.facebook.com/iestplurinOFICIAL/?locale=es_LA" className="footer-icon"><i className="fab fa-facebook-f"></i></a>
