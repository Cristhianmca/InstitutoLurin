...
const Noticias = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      setCanScrollRight(
        Math.round(position) < events.scrollWidth - events.clientWidth
      );
    };
  ...
  return (
    <>
      {/* Helmet para SEO */}
      <Helmet>
        <title>Noticias del Instituto Lurín</title>
        <meta
          name="description"
          content="Mantente informado sobre las últimas noticias y eventos del Instituto Lurín, incluyendo la Semana Deportiva, Exámenes de Admisión y más."
        />
        <meta
          name="keywords"
          content="Noticias, Instituto Lurín, eventos, admisión, semana deportiva, aniversario"
        />
      </Helmet>
      ...
      <div className="container_noticias-total">
        <div className="container_noticias">
          ...
          >
            <Link to="/noticias" className="event">
              <div className="event__image">
                <img
                  src="https://i.postimg.cc/1XgZWxLG/018.png"
                  alt="The Weeknd"
                />
